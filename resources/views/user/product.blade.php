        ...
        <div class="row" style="min-height: 600px;">
            ...
            <div class="col-lg-6">
                <form method="POST" action="{{ route('cart.store') }}">
                    ...
                    <input type="hidden" name="variation" value="main-{{ $products->id }}">
                            ...
                            <div class="d-flex border-bottom py-4 gap-3" id="feedback-{{ $feedback->id }}">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex gap-1 mb-2">
                                        @for ($i = 0; $i < $rating; $i++)
                                            <img class="img-fluid" src="{{ asset('img/star.svg') }}" alt="star" width="20">
                                        @endfor
                                        @for ($i = $rating; $i < 5; $i++)
                                            <img class="img-fluid" src="{{ asset('img/star-disabled.svg') }}" alt="star-disabled" width="20">
                                        @endfor
                                    </div>
